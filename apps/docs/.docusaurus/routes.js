            ...
            routes: [
              {
                ...
                component: ComponentCreator('/docs/admin/pagination', '9dc'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/bundles/pricing', 'c7e'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/checkout/inventory-flow', 'bb0'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/orders/fulfillment', '0a6'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
                path: '/docs/orders/inventory-reconciliation',
                component: ComponentCreator('/docs/orders/inventory-reconciliation', '013'),
                exact: true,
                sidebar: "docsSidebar"
              },
              {
